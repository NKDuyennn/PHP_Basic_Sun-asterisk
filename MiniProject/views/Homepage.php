...
<div class="container-fluid">
  ...
  <h1>All Posts</h1>
  <hr>
  <a href="?controller=Post&action=listMyPosts" class="btn btn-primary">My Posts</a>
  <?php 
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="tablemyposts" width="100%" cellspacing="0">
        <thead>
          <tr>
            <th>ID</th>
            <th>Title</th>
          ...
          foreach ($data as $row) {
            ...
            <tr>
              ...
              <td  style="text-align: center;">
                ...
                <?php if ($_SESSION['user']['id'] == $row['author_id']): ?>
